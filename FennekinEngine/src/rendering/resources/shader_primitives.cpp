#include <gl/glew.h>
#include "shader_primitives.hpp"

#include <cstring>


SkyboxShader::SkyboxShader()
    : Shader(ShaderPath("content/shaders/builtin/skybox.vert"),
             ShaderPath("content/shaders/builtin/skybox.frag")) {}
...
ScreenShader::ScreenShader()
    : Shader(ShaderPath("content/shaders/builtin/screen_quad.vert"),
             ShaderPath("content/shaders/builtin/screen_quad.frag")) {}
...
ScreenLodShader::ScreenLodShader()
    : ScreenShader(ShaderPath("content/shaders/builtin/screen_quad_lod.frag")) {
}

ShadowMapShader::ShadowMapShader()
    : Shader(ShaderPath("content/shaders/builtin/shadow_map.vert"),
             ShaderPath("content/shaders/builtin/shadow_map.frag")) {}
