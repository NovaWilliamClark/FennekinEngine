...
void main() {
  fnk_generateNormalLine(gl_in[0].gl_Position,
                         projectNormal(gs_in[0].fragNormal), 0.05);
  fnk_generateNormalLine(gl_in[1].gl_Position,
                         projectNormal(gs_in[1].fragNormal), 0.05);
  fnk_generateNormalLine(gl_in[2].gl_Position,
